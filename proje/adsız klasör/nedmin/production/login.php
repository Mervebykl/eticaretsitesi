      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div>
            <button style="width: 100%; background-color:skyblue; color:white;" type="submit" name="admingiris" class="btn btn-default"> Giriş Yap</button>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-star"></i> Moda Burada</h1>
              </div>
            </div>
          </form>
