		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="index.php"><img src="images\mlogo.png" width="80" height="90" alt="logo" class="logo img-responsive"></a>
				</div>
				<div class="col-md-8">
					<div class="pushright">
						<div class="top">
							...
							<a href="#" id="reg" class="btn btn-default btn-dark">Giriş<span>/</span>Kayıt</a>
							<?php } else { ?>
                 ...
                 <div class="form-group">
                   <button type="submit" name="kullanicigiris" class="btn btn-default btn-red btn-sm">Giriş Yap</button>
									...
									<div class="col-md-6">
										...
										<p>
											Hala üye olmadın mı? Bir hesap oluşturarak daha hızlı alışveriş yapabilir, bir siparişin durumundan haberdar olabilirsiniz...
										</p>
				...
				<div class="row">
					<div class="col-md-10">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<li><a href="kadingiyim.php">Kadın Giyim</a><div class="curve"></div></li>
								<li><a href="erkekgiyim.php">Erkek Giyim</a><div class="curve"></div></li>
								<li><a href="cocuk.php">Çocuk Giyim</a><div class="curve"></div></li>
								<li><a href="ayakkabi.php">Ayakkabı</a><div class="curve"></div></li>
					...
					if (isset($_SESSION['userkullanici_mail'])){?>
						<ul class="small-menu"><!--small-nav -->
									...
									<li><a href="siparislerim" class="myshop">Sepetim</a></li>
									<li><a href="logout.php" class="mycheck">Çıkış</a></li>
								</ul>
